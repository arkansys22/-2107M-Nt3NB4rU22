!function(a){
  ...
  function(b){
    ...
    var b=new Date;a("#countdown").countdown(
      "2018/10/13 08:00:00",function(b){a(this).html(b.strftime("<ul><li>%D <span>Days</span></li> <li>%H <span>Hours</span></li> <li>%M <span>Minutes</span></li> <li>%S <span>Seconds</span></li> </ul>"))});
