!function(a){
  ...
  function(b){
    ...
    var b=new Date;a("#countdown").countdown(
      "2018/11/05 08:00:00",function(b){a(this).html(b.strftime("<ul><li>%D <span>Hari</span></li> <li>%H <span>Jam</span></li> <li>%M <span>Menit</span></li> <li>%S <span>Detik</span></li> </ul>"))});
