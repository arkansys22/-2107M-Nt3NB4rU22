...
<head>
     <title>Yeni & Yudis - Undangan Pernikahan Online Mantenbaru</title>
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/template/frontend/style/images/favicon.png">
    <meta charset="UTF-8">
    <meta name="description" content="Yeni & Yudis - Undangan Pernikahan Online Mantenbaru">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/style_yeni_yudis.css">
    ...
    <script src="<?php echo base_url()?>assets/template/frontend/love_bird/js/modernizr.custom.js"></script>
        ...
        <meta property="og:title" content="Yeni & Yudis - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Yeni & Yudis | Undangan Pernikahan Online Manten Baru">
        <meta property="og:description" content="Yeni & Yudis - Undangan Pernikahan Online Manten Baru">
...
<div class="resonsive-tab">
      ...
      <div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="<?php echo base_url()?>dira_fiqih"><h5>Yeni & Yudis</h5></a></div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>dira_fiqih" data-menu="index"><h5>Yeni & Yudis</h5></a> </div>
    <div class="ver-menu">
    ...
    C37.105,43.822,36.97,43.864,36.835,43.864z" />
        ...
        <li data-animation="5" class="hvr-overline-from-center"> <a href="#0" data-menu="projects">
          ...
          <div class="clearfix"></div>消息消息</a> </li>
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      <h1 class="wow fadeInLeft">Yeni</h1>
                      <span class="glyphicon glyphicon-heart"></span>
                      <h1 class="wow fadeInRight">Yudis</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>星期六, 2018年1月5日</span></p>
                    </div>
                <div class="clearfix"></div>
                <div class="countdown countdown-container container">
                    ...
                    <div class="clock-item clock-days countdown-time-value wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0.25s">
                        ...
                        <div class="inner">
                              ...
                              <div class="text">
                            <p class="val">0</p>
                            <p class="type-days type-time">天</p>
                          </div>
                            </div>
                      </div>
                        </div>
                    <div class="clock-item clock-hours countdown-time-value wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0.33s">
                        ...
                        <div class="inner">
                              ...
                              <div class="text">
                            <p class="val">0</p>
                            <p class="type-hours type-time">小时</p>
                          </div>
                            </div>
                      </div>
                        </div>
                    <div class="clock-item clock-minutes countdown-time-value wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0.37s">
                        ...
                        <div class="inner">
                              ...
                              <div class="text">
                            <p class="val">0</p>
                            <p class="type-minutes type-time">分钟</p>
                          </div>
                            </div>
                      </div>
                        </div>
                    <div class="clock-item clock-seconds countdown-time-value wow bounceInUp" data-wow-duration="1.5s" data-wow-delay="0.42s">
                        ...
                        <div class="inner">
                              ...
                              <div class="text">
                            <p class="val">0</p>
                            <p class="type-seconds type-time">第二</p>
                          </div>
                            </div>
                      </div>
                        </div>
                  ...
                  <br />
                  <a href="<?php echo base_url()?>" target="_blank"><img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/logobottom.png" /></a>
                    </div>
              </div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/8.jpg" alt="the-couple image" class="img-circle">
                            
                          </div>
                            </div>
                        <div class="the-couple-data">
                              <h3>Yeni Inggrid Yesika</h3>
                              <p class="about-the-couple">Putri dari Bapak & Ibu</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/7.jpg" alt="the-couple image" class="img-circle">
                       
                      </div>
                        </div>
                    <div class="the-couple-data">
                          <h3>Yudis Purnama</h3>
                          <p class="about-the-couple">Putra Bapak & Ibu </p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>婚礼活动<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="container">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                          ...
                          <p>Monumen Nasional Indonesia</p>
                        </div>
                  </div>
    ...
    <div class="pt-page pt-page-4">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>照片库<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="page-top display_none">
                      <div class="gridlayout-main">
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/fotogaleri.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/fotogaleri.jpg">
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>消息消息<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="container">
                      <div class="rsvp">
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                          <div  class="fb-comments" data-href="https://www.mantenbaru.com/yeni_yudis/" data-numposts="5" data-mobile="mobile" ></div>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-6">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>位置图<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                    <div class="container">
                         <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7933.332859945221!2d106.827153!3d-6.175392!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3d2ad6e1e0e9bcc8!2sNational+Monument!5e0!3m2!1sen!2sid!4v1536034755278" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                       </div>
              </div>
                </div>
          </div>
