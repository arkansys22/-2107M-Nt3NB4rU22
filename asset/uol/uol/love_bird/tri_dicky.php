...
<head>
     <title>Tri & Dicky - Undangan Pernikahan Online Mantenbaru</title>
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/template/frontend/style/images/favicon.png">
    <meta charset="UTF-8">
    <meta name="description" content="Tri & Dicky - Undangan Pernikahan Online Mantenbaru">
    <meta name="author" content="mantenbaru.com">
    <meta name="site_url" content="<?php echo base_url()?>tri_dicky/">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href='https://fonts.googleapis.com/css?family=Great+Vibes' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/style_fiqih.css">
    ...
    <script src="<?php echo base_url()?>assets/template/frontend/love_bird/js/modernizr.custom.js"></script>
        ...
        <meta property="og:title" content="Tri & Dicky - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Tri & Dicky | Undangan Pernikahan Online Manten Baru">
        <meta property="og:description" content="Tri & Dicky - Undangan Pernikahan Online Manten Baru">
        <meta property="og:url" content="<?php echo base_url()?>tri_dicky/">
        <meta property="og:image" content="<?php echo base_url()?>assets/template/frontend/tema_manten/img/the-heart-welcome-bg.jpg">
        <meta property="og:image:url" content="<?php echo base_url()?>assets/template/frontend/tema_manten/img/the-heart-welcome-bg.jpg">
...
<audio autoplay loop id="mySound" >
      <source src="<?php echo base_url(); ?>assets/template/frontend/backsound/payung_teduh_akad.mp3" type="audio/mpeg">
    </audio>    
 <script>
$(document).ready(function(){
	$("#over-layar").click(function(){
			$("#over-layar").fadeOut(200);
		});
});
</script> 
<div onclick="playAudio()" type="button" id="over-lay" style="display: none;">
...
<div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="<?php echo base_url()?>tri_dicky"><h5>Tri & Dicky</h5></a></div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>tri_dicky" data-menu="index"><h5>Tri & Dicky</h5></a> </div>
    <div class="ver-menu">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      <h1 class="wow fadeInLeft">Tri</h1>
                      <span class="glyphicon glyphicon-heart"></span>
                      <h1 class="wow fadeInRight">Dicky</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>Sabtu, 27 Oktober 2018</span></p>
                    </div>
                <div class="clearfix"></div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/foto_manten/fiqih-foto_dira.png" alt="the-couple image" class="img-circle">
                        ...
                        <div class="the-couple-data">
                              <h3>Tri Apricelia</h3>
                              <p class="about-the-couple">Putri ke 3 dari Bapak Rais Fattah & Ibu Hj. Almiah Abdullah (Alm)</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/foto_manten/fiqih-foto_fiqih.png" alt="the-couple image" class="img-circle">
                        <div class="the-couple-img-hover">
                              <div class="social text-center"><a class="fb-color" href="#" target="_blank"><i class="fa fa-facebook"></i></a><a class="tw-color" href="#" target="_blank"><i class="fa fa-twitter"></i></a><a class="gp-color" href="#" target="_blank"><i class="fa fa-google-plus"></i></a></div>
                            </div>
                      </div>
                    ...
                    <div class="the-couple-data">
                          <h3>Dicky Dwi Putra</h3>
                          <p class="about-the-couple">Putra ke 2 dari Bapak M. Jafar & Ibu Dian Maryamah</p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                        ...
                        <p>19.00 WIB</p>
                          <img class="pin-icon" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/pin.png" alt="locationimage">
                          <p>Gedung Bea Cukai, Jl. Ahmad Yani Rawamangun, Jakarta Timur</p>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="page-top display_none">
                    ...
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-1.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-1.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-2.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-2.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-3.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-3.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-4.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-4.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-5.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-5.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-6.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/foto_manten/gallery-6.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                          <div  class="fb-comments" data-href="https://www.mantenbaru.com/tri_dicky/" data-numposts="5" data-mobile="mobile" ></div>
                        </div>
                  </div>
                    </div>
              </div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                    ...
                    <div class="container">
                         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d935.9533970178703!2d106.8752798!3d-6.2065725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f48566a071ef%3A0x600f3ad15637ed13!2sDirectorate+General+of+Customs+and+Excise!5e0!3m2!1sen!2sid!4v1539769723603" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/function_tri.js"></script>
