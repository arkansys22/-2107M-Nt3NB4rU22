...
<head>
     <title>Dira & Fiqih - Undangan Pernikahan Online Mantenbaru</title>
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/template/frontend/style/images/favicon.png">
    <meta charset="UTF-8">
    <meta name="description" content="Dira & Fiqih - Undangan Pernikahan Online Mantenbaru">
    <meta name="author" content="mantenbaru.com">
    <meta name="site_url" content="<?php echo base_url()?>dira_fiqih/">
    ...
    <script src="<?php echo base_url()?>assets/template/frontend/love_bird/js/modernizr.custom.js"></script>
        ...
        <meta property="og:title" content="Dira & Fiqih - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Dira & Fiqih | Undangan Pernikahan Online Manten Baru">
        <meta property="og:description" content="Dira & Fiqih - Undangan Pernikahan Online Manten Baru">
        <meta property="og:url" content="<?php echo base_url()?>dira_fiqih/">
...
.has-error .form-control:focus ~ label, .has-error .form-control.dirty ~ label {
    ...
    <body>
            <audio autoplay="" loop="" id="mantenAudio"><source src="<?php echo base_url(); ?>assets/fiqih_bgsound.mp3" type="audio/mpeg"></audio>
...
<div class="resonsive-tab">
      ...
      <div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="<?php echo base_url()?>dira_fiqih"><h5>Dira & Fiqih</h5></a></div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>dira_fiqih" data-menu="index"><h5>Dira & Fiqih</h5></a> </div>
    <div class="ver-menu">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      <h1 class="wow fadeInLeft">Dira</h1>
                      <span class="glyphicon glyphicon-heart"></span>
                      <h1 class="wow fadeInRight">Fiqih</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>Sabtu, 08 September 2018</span></p>
                    </div>
                <div class="clearfix"></div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-data">
                              <h3>Indira Maulindra S.E</h3>
                              <p class="about-the-couple">Putri bungsu dari Alm. Bapak Hendra Hariyanto & Ibu Sudi Hasniarti</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-data">
                          <h3>Fiqih Fadliki Muslim S.Kom</h3>
                          <p class="about-the-couple">Putra sulung dari Bapak Muslim Ahmad & Ibu Rina Usman</p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                         ...
                         <h5>Resepsi Nikah</h5>
                        <h4>Sabtu, 8 September 2018</h4>
                        <p>19.00 s/d 21.00 WIB</p>
                          <img class="pin-icon" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/pin.png" alt="locationimage">
                          <p>Gedung Auditorium Perpustakaan Nasional RI, Jl. Salemba Raya No.28A, Jakarta Pusat</p>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                          <div  class="fb-comments" data-href="http://mantenbaru.com/dira_fiqih/" data-numposts="5" data-mobile="mobile" data-width="100%"></div>
                        </div>
                  </div>
                    </div>
              </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                    ...
                    <div class="container">
                      ...
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31731.912381412203!2d106.83388933883472!3d-6.1990268038082!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f4688a69ac15%3A0xe6771751b3cd3bc9!2sPerpustakaan+Nasional+RI%2C+Salemba!5e0!3m2!1sen!2sid!4v1534311294279" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
              </div>
                </div>
          </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/function_fiqih.js"></script>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/formValidation.js"></script>
        <div id="fb-root"></div>
            ...
            <script>
                var x = document.getElementById("mantenAudio"); 
                function playAudio() { 
                    x.play(); 
                } 
                function pauseAudio() { 
