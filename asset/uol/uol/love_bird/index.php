...
<head>
    <link rel="shortcut icon" href="<?php echo base_url()?>assets/template/frontend/style/images/favicon.png">
    <meta charset="UTF-8">
    <title>Miftah & Japar - Undangan Pernikahan Online Manten Baru</title>
    <meta name="description" content="Miftah & Japar - Undangan Pernikahan Online Manten Baru">
    <meta name="author" content="mantenbaru.com">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href='https://fonts.googleapis.com/css?family=Great+Vibes' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/style.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/bootstrap.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/timer.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/animations.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/component.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/slick.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/slick-theme.css">
    <link type="text/css" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/jquery.countdown.css" rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/gridlayout.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/jquery.fancybox.css" media="screen" />
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/materialadmin.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/font-awesome.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/animate.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/template/frontend/love_bird/css/hover.css">
    <script src="<?php echo base_url()?>assets/template/frontend/love_bird/js/modernizr.custom.js"></script>
    
    <meta property="og:title" content="Miftah & Japar - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Miftah & Japar - Undangan Pernikahan Online Manten Baru">
        <meta property="og:description" content="Miftah & Japar - Undangan Pernikahan Online Manten Baru">
        <meta property="og:url" content="<?php echo base_url()?>miftah_japar/">
        <meta property="og:image" content="<?php echo base_url()?>assets/template/frontend/love_bird/images/home-back.png">
        <meta property="og:image:url" content="<?php echo base_url()?>assets/template/frontend/love_bird/images/home-back.png">
...
<div class="resonsive-tab">
      <div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="index.html"><h5>Miftah & Japar</h5></a></div>
          <div class="hamburger pull-right"> <img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/1466014460_menu-alt.png" alt="Navicon"> </div>
    </div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>" data-menu="index"><h6>Miftah & Japar</h6></a> </div>
    <div class="ver-menu">
          <ul class="dl-menu nav navbar-nav menubar-s2 horizontal_iconmenu" style="position: relative;">
        <li data-animation="1" class="hvr-overline-from-center hover_active"> <a href="#0" data-menu="index">
          <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve" fill="#f0394d">
          <g>
            <g>
          ...
          <div class="clearfix"></div>
          Beranda </a> </li>
        <li data-animation="2" class="hvr-overline-from-center"> <a href="#0" data-menu="couple">
          <svg version="1.1" id="Layer_2" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
          <g>
            <g>
    ...
    C37.105,43.822,36.97,43.864,36.835,43.864z" />
        ...
        <li data-animation="5" class="hvr-overline-from-center"> <a href="#0" data-menu="projects">
          <svg version="1.1" id="Layer_7" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
          <g>
            <g>
              <path d="M26.541,15.483C26.54,15.483,26.541,15.483,26.541,15.483c-0.914,0-1.55-0.041-1.577-0.042
            c-0.322-0.021-0.58-0.274-0.607-0.595c-0.046-0.545-0.394-5.37,1.479-7.021c0.932-0.822,2.166-1.274,3.475-1.274
            c1.309,0,2.543,0.452,3.475,1.274c0.955,0.842,1.481,1.968,1.482,3.171c0,1.203-0.526,2.33-1.482,3.172
            C31.796,15.04,29.695,15.483,26.541,15.483z M25.62,14.165c0.247,0.008,0.563,0.014,0.92,0.014c2.708,0,4.671-0.361,5.385-0.989
            c0.671-0.591,1.04-1.371,1.04-2.195c0-0.824-0.37-1.603-1.04-2.194c-0.694-0.612-1.622-0.949-2.614-0.949
            c-0.991,0-1.919,0.337-2.614,0.949C25.757,9.63,25.543,12.32,25.62,14.165z" />
            </g>
            <g>
              <path d="M23.268,15.483c-2.437,0-5.63-0.254-7.004-1.465c-1.062-0.936-1.646-2.187-1.646-3.522c0-1.335,0.585-2.585,1.646-3.521
            c1.038-0.915,2.412-1.418,3.871-1.418c1.458,0,2.833,0.504,3.871,1.418c2.086,1.838,1.695,7.253,1.643,7.864
            c-0.027,0.321-0.285,0.574-0.607,0.595C25.013,15.437,24.297,15.483,23.268,15.483z M20.135,6.86c-1.141,0-2.21,0.388-3.009,1.093
            c-0.777,0.685-1.205,1.588-1.205,2.543c0,0.956,0.428,1.86,1.205,2.544c0.822,0.724,3.061,1.14,6.143,1.14
            c0.443,0,0.828-0.009,1.118-0.019c0.077-1.77-0.035-5.144-1.242-6.208C22.345,7.248,21.276,6.86,20.135,6.86z" />
            </g>
            <g>
              <path d="M19.584,27.943c-0.258,0-0.501-0.154-0.604-0.407c-0.096-0.238-2.326-5.865-0.031-9.841
            c1.129-1.957,3.137-3.151,5.967-3.55c0.115-0.016,0.231-0.002,0.337,0.042c0.301,0.123,7.379,3.088,7.304,9.279
            c-0.004,0.357-0.295,0.643-0.651,0.643c-0.003,0-0.005,0-0.008,0c-0.36-0.004-0.648-0.299-0.643-0.659
            c0.059-4.849-5.341-7.534-6.338-7.988c-2.315,0.362-3.942,1.331-4.838,2.881c-1.978,3.421,0.088,8.653,0.109,8.705
            c0.134,0.333-0.027,0.713-0.361,0.847C19.747,27.927,19.665,27.943,19.584,27.943z" />
            </g>
            <g>
              <path d="M43.209,23.068H13.142c-0.36,0-0.651-0.292-0.651-0.651c0-0.36,0.292-0.651,0.651-0.651h29.415v-6.329H7.443v6.329h3.007
            c0.36,0,0.651,0.292,0.651,0.651c0,0.36-0.292,0.651-0.651,0.651H6.791c-0.36,0-0.651-0.292-0.651-0.651v-7.632
            c0-0.36,0.292-0.651,0.651-0.651h36.418c0.36,0,0.651,0.292,0.651,0.651v7.632C43.86,22.776,43.569,23.068,43.209,23.068z" />
            </g>
            <g>
              <path d="M41.634,44.443H8.366c-0.36,0-0.651-0.292-0.651-0.651V22.417c0-0.36,0.292-0.651,0.651-0.651
            c0.36,0,0.651,0.292,0.651,0.651V43.14h31.966V22.417c0-0.36,0.292-0.651,0.651-0.651c0.36,0,0.651,0.292,0.651,0.651v21.375
            C42.286,44.151,41.994,44.443,41.634,44.443z" />
            </g>
            <g>
              <path d="M25.053,44.443c-0.36,0-0.651-0.292-0.651-0.651v-28.96c0-0.36,0.292-0.651,0.651-0.651c0.36,0,0.651,0.292,0.651,0.651
            v28.96C25.704,44.151,25.412,44.443,25.053,44.443z" />
            </g>
          </g>
          </svg>
          <div class="clearfix"></div>Pesan</a> </li>
        <li data-animation="6" class="hvr-overline-from-center"> <a href="#0" data-menu="projects">
          <svg version="1.1" id="Layer_8" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
          <g>
            <g>
        ...
        <!-- menu for mobile devices starts from here-->
      </ul>
        </div>
  </div>
    </div>
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      <h1 class="wow fadeInLeft">Miftah</h1>
                      <span class="glyphicon glyphicon-heart"></span>
                      <h1 class="wow fadeInRight">Japar</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>Sabtu, 2 Desember 2018</span></p>
                    </div>
                <div class="clearfix"></div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>Manten Baru<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/bride.jpg" alt="the-couple image" class="img-circle">
                        ...
                        <div class="the-couple-data">
                              <h3>Miftah Ulfa</h3>
                              <p class="about-the-couple">Putri kedua dari Bapak Luthfie dan Ibu Bibi Hamilah</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>assets/template/frontend/love_bird/images/groom.jpg" alt="the-couple image" class="img-circle">
                        <div class="the-couple-img-hover">
                              <div class="social text-center"><a class="fb-color" href="#" target="_blank"><i class="fa fa-facebook"></i></a><a class="tw-color" href="#" target="_blank"><i class="fa fa-twitter"></i></a><a class="gp-color" href="#" target="_blank"><i class="fa fa-google-plus"></i></a></div>
                            </div>
                      </div>
                    ...
                    <div class="the-couple-data">
                          <h3>Japar Sidik Prakoso</h3>
                          <p class="about-the-couple">Putra pertama dari Bapak Wariso dan Ibu Pariyem</p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>Pernikahan<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="container wedding-person">
                      <div class="couple-name">
                    <h1 class="wow fadeInLeft" data-class="fadeInLeft">Miftah Ulfa</h1>
                    <span class="glyphicon glyphicon-heart wow fadeInLeft" data-class="fadeInLeft" ></span>
                    <h1 class="wow fadeInRight" data-class="fadeInRight">Japar Sidik Prakoso</h1>
                  </div>
                    </div>
                <div class="container">
                      <div class="col-md-12 about-the-people">
                    <p class="col-md-6 col-md-offset-3 col-xs-12 wow fadeInLeft" data-class="fadeInLeft">Akan Diselenggarakan Pada Waktu dan Lokasi</p>
                  </div>
                    </div>
                <div class="container ceremony-section">
                      <div class="col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-12 col-xs-offset-0 responsive-margin text-center wow fadeInUp padding-left-right-zero" data-class="fadeInUp">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                          ...
                          <h5>Akad Nikah</h5>
                          <h4>Sabtu, 2 Desember 2018</h4>
                          <p>09.00 WIB - Selesai</p>
                          <img class="pin-icon" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/pin.png" alt="locationimage">
                          <p>Gg.Rambutan Pancoran Mas,Rt. 04 Rw. 06 No. 62,Kel & Kec. Pancoran Mas, Depok </p>
                        </div>
                  </div>
                      <div class="col-md-6 col-md-offset-0 col-sm-6 col-sm-offset-0 col-xs-12 col-xs-offset-0 responsive-margin text-center wow fadeInRight padding-left-right-zero" data-class="fadeInRight">
                    <div class="white-box ceremony-detail"> <svg version="1.1"
                                                     x="0px" y="0px" width="150.273px" height="161.365px" viewBox="0 0 150.273 161.365" enable-background="new 0 0 150.273 161.365"
                                                     xml:space="preserve">
                      <defs></defs>
    ...
    <div class="pt-page pt-page-4">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>Galeri<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="page-top display_none">
                      <div class="gridlayout-main">
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah1.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah1.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah2.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah2.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah3.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah3.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah4.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah4.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah5.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah5.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah6.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah6.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                            <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah7.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>assets/template/frontend/love_bird/images/gallery/miftah7.jpg">
                              <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                              </a> </div>
                        </div>
                  </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>Doa & Pesan<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                <div class="container">
                      <div class="rsvp">
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                          <div  class="fb-comments" data-href="http://mantenbaru.com/miftah_japar/" data-numposts="5" data-mobile="mobile" data-width="100%"></div>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-6">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                  <div class="col-md-12">
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      <h2>Peta Lokasi<span><i class="glyphicon glyphicon-heart"></i></span></h2>
                    </div>
                    <div class="container">
                         
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d495.61260683231836!2d106.80931280084062!3d-6.406772273500318!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69e96432390ec7%3A0x2ae50b61accdf33f!2sGg.+Rambutan%2C+Pancoran+MAS%2C+Kota+Depok%2C+Jawa+Barat+16436!5e0!3m2!1sen!2sid!4v1509769293125" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
                        </div>
              </div>
                </div>
          </div>
...
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery-2.1.4.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/function.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/slick.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/easyResponsiveTabs.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/timer.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.final-countdown.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.dlmenu.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/pagetransitions.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.countdown.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.masonarygrid.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.fancybox.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/menu.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/wow.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>assets/template/frontend/love_bird/js/formValidation.js"></script>
        <div id="fb-root"></div>
