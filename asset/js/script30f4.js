(function($) {
    ...
    if ($("#clock").length) {
        ...
        var marrigeDate = new Date(2019, 1-1, 6);
        marrigeDate.setHours(10);
    ...
    -------------------------------------------*/
        ...
        var locations = [
            ['Masjid Al-Akbar, Surabaya',-7.8330502, 110.4072292,2],
        ];

        var map = new google.maps.Map(document.getElementById('map'), {
            center: new google.maps.LatLng(-7.8330502, 110.4072292),
            zoom: 17,
            scrollwheel: false,
        ...
        var infowindow = new google.maps.InfoWindow();
				...
				var myLatLng = {lat: -7.833550, lng: 110.407133};
				var marker = new google.maps.Marker({
          position: myLatLng,
          map: map,
          title: 'Gedung Pertemuan Taman Perwacy'
        });

				google.maps.event.addListener(marker, 'click', function() {
					window.open("https://goo.gl/maps/xPikVhDu2uG2");
				});
    };
