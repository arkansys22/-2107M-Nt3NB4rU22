    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Facebook</th>               <td><input type='text' class='form-control' name='fb' value='$record[facebook]'></td></tr>
                    <tr><th scope='row'>Instagram</th>               <td><input type='text' class='form-control' name='ig' value='$record[instagram]'></td></tr>
                    <tr><th scope='row'>Youtube</th>               <td><input type='text' class='form-control' name='ytb' value='$record[youtube]'></td></tr>
                    ...
                    <tr><th scope='row'>Alamat</th>               <td><textarea class='form-control' name='alamat' style='height:80px'>$record[alamat]</textarea></td></tr>
                    ...
                    <tr><th scope='row'>Logo</th>                      <td><input type='file' class='form-control' name='logo' value='$record[logo]'><hr style='margin:5px'>
                                                                              Favicon Aktif Saat ini : <img style='width:32px; height:32px' src='".base_url()."asset/images/$record[logo]'></td></tr>
