<?php
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_listvendor',$attributes);
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Harga Minimal</th>
                      <td><input type='number' class='form-control' value='$rows[harga_min]' name='hargamin' ></td>
                    </tr>
                    <tr><th scope='row'>Harga Maksimal</th>
                      <td><input type='number' class='form-control' value='$rows[harga_max]' name='hargamax' ></td>
                    </tr>
                    ...
                    <tr><th scope='row'>Durasi(Jam)</th>
                      <td><input type='number' class='form-control' value='$rows[durasi]' name='durasi'></td>
                    </tr>
                    <tr><th scope='row'>Ganti Gambar 1</th>
                        ...
                        <tr><th scope='row'>Ganti Gambar 2</th>
                            ...
                            if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini :
                              </i><a target='_BLANK' href='".base_url()."asset/foto_vendor/$rows[gambar2]'>$rows[gambar2]</a>"; } echo "
                            </td></tr>
                            <tr><th scope='row'>Ganti Gambar 3</th>
                                <td><input type='file' class='form-control' name='img3'>";
                                if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini :
                                  </i><a target='_BLANK' href='".base_url()."asset/foto_vendor/$rows[gambar3]'>$rows[gambar3]</a>"; } echo "
                                </td></tr>
                                <tr><th scope='row'>Ganti Gambar 4</th>
                                    <td><input type='file' class='form-control' name='img4'>";
                                    if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini :
                                      </i><a target='_BLANK' href='".base_url()."asset/foto_vendor/$rows[gambar4]'>$rows[gambar4]</a>"; } echo "
                                    </td></tr>
                                    <tr><th scope='row'>Ganti Gambar 5</th>
                                        <td><input type='file' class='form-control' name='img5'>";
                                        if ($rows['gambar'] != ''){ echo "<i style='color:red'>Lihat Gambar Saat ini :
                                          </i><a target='_BLANK' href='".base_url()."asset/foto_vendor/$rows[gambar5]'>$rows[gambar5]</a>"; } echo "
                                        </td></tr>
