            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url(); ?>administrator/tambah_listpromo'>Tambah Vendor</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$status</td>
                              <td><center>
                                <a class='btn btn-primary btn-xs' title='Publish/UnPublish' href='".base_url()."administrator/publish_listpromo/$row[id_berita]/$row[status]'><span class='glyphicon glyphicon-ok'></span></a>
