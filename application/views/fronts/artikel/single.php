...
<html lang="en">
  <head>
    <?php $this->load->view('fronts/artikel/meta')?>
    ...
    <div class="detail-wrapper">
      <div class="container">
            ...
            <div class="share clearfix">
              ...
              <ul>
                <li class="color-fb"><a href="http://www.facebook.com/sharer.php?u=<?php echo base_url("artikel/$post_news->judul_seo") ?>" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo base_url("artikel/$post_news->judul_seo")?>','newwindow','width=400,height=350');  return false;" title="Facebook" target="_blank" ><i class="fa fa-facebook" ></i>Facebook</a></li>
                <li class="color-ig"><a href="whatsapp://send?text=<?php echo $post_news->judul ?> - Mantenbaru| <?php echo base_url("artikel/$post_news->judul_seo") ?>"><i class="fa fa-whatsapp"></i>Whatsapp</a></li>
              </ul>
            </div>
              </div>
