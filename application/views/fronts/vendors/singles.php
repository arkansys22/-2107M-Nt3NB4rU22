												    			 ...
												    			 <div class="blog-list">
												    			    <div class="blog-list-entry">
                                                						<div class="blog-list-top">
                                                				                    		 <img class="img-responsive img-full" <?php if(empty($post_v->foto1)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
                                                                         			        else { echo " <img src='".base_url()."asset/projek/".$post_v->foto1."'> ";}
                                                                         			    ?>
                                                				                    		 <img class="img-responsive img-full" <?php if(empty($post_v->foto2)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
                                                                         			        else { echo " <img src='".base_url()."asset/projek/".$post_v->foto2."'> ";}
                                                                         			    ?>
                                                				                    		 <img class="img-responsive img-full" <?php if(empty($post_v->foto3)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
                                                                         			        else { echo " <img src='".base_url()."asset/projek/".$post_v->foto3."'> ";}
                                                                         			    ?>
                                                				                    		 <img class="img-responsive img-full" <?php if(empty($post_v->foto4)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
                                                                         			        else { echo " <img src='".base_url()."asset/projek/".$post_v->foto4."'> ";}
                                                                         			    ?>		 
                                                				                    		 <img class="img-responsive img-full" <?php if(empty($post_v->foto5)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
