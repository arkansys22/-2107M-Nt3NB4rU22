  				...
  				<div class="sidebar bg-white clearfix">
						<div class="sidebar-block">
										<div class="hotel-small style-2 clearfix">
										     <img class="img-responsive noborder hotel-img" <?php if(empty($post_h->gambar)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
										...
										<div class="rate">
											...
											<div class="contact-line"><p><i class="fa fa-envelope-o"></i><a href="mailto:<?php echo $post_h->email?>"> <?php echo $post_h->email?></p></a></div>
											<a href="mailto:<?php echo $post_h->nomerbisnis?>"><div class="contact-line"><p><i class="fa fa-phone"></i> <?php echo $post_h->nomerbisnis?></p></div></a>
											<div class="contact-line"><p><strong>Media Sosial</strong></p></div>
											<div class="contact-line">
												<a target="_blank" href="https://api.whatsapp.com/send?phone=+62<?php echo $post_h->nowhatsapp?>&text=Halo,%20Saya%20menemukan%20<?php echo $post_h->namabisnis?>%20di%20Mantenbaru.com.%20Bisa%20bantu%20saya?" class="button-s-2 bg-4 m-right"><i class="fa fa-whatsapp"> WA</i></a>
											...
											<hr>
											<div class="contact-line">
												<center><a href="https://api.whatsapp.com/send?phone=+62<?php echo $post_h->nowhatsapp?>&text=Halo,%20Saya%20menemukan%20<?php echo $post_h->namabisnis?>%20di%20Mantenbaru.com.%20Saya%20mau%20tanya-tanya%20dulu." class="c-button small bg-dr-blue-2 hv-dr-blue-2-o"><i class="fa fa-comments-o"> Kirim Penawaran</i></a></center>
											</div>
											<br>
											<div class="row contact-line">
												<center><a href="https://api.whatsapp.com/send?phone=+62<?php echo $post_h->nowhatsapp?>&text=Halo,%20Saya%20menemukan%20<?php echo $post_h->namabisnis?>%20di%20Mantenbaru.com.%20Saya%20mau%20tanya%20harga%20dulu." class="c-button small bg-dr-blue-2 hv-dr-blue-2-o"><i class="fa fa-question-circle"> Cek Detail Harga</i></a></center>
											</div>
											<hr>
												    			    ...
												    			    <div class="blog-list-entry">
                                                						<div class="blog-list-top">
                                                				                    		 ...
                                                				                    		 <?php if(empty($post_h->foto_h)) {
                                                				                    		  echo "<img src='".base_url()."asset/frontend/noimage.png'>";
