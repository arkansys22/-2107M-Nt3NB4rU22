...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/style_yeni_yudis.css">
...
<link rel="shortcut icon" href="https://www.mantenbaru.com/asset/frontend/aspanel/img/fav.png" type="image/x-icon">
        ...
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/tema_manten/img/the-heart-welcome-bg.jpg">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/tema_manten/img/the-heart-welcome-bg.jpg">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/8.jpg" alt="the-couple image" class="img-circle">
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/7.jpg" alt="the-couple image" class="img-circle">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-top display_none">
                    ...
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/fotogaleri.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/fotogaleri.jpg">
