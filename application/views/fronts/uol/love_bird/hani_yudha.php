...
<head>
     <title>Hani & Yudha - Undangan Pernikahan Online Mantenbaru</title>
    ...
    <meta name="site_url" content="<?php echo base_url()?>hani_yudha/">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href='https://fonts.googleapis.com/css?family=Great+Vibes' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/style_hani.css">
    ...
    <link rel="shortcut icon" href="https://www.mantenbaru.com/asset/frontend/aspanel/img/fav.png" type="image/x-icon">
        ...
        <meta property="og:title" content="Hani & Yudha - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Hani & Yudha | Undangan Pernikahan Online Manten Baru">
        ...
        <meta property="og:url" content="<?php echo base_url()?>hani_yudha/">
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-1.jpg">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-1.jpg">
...
<audio autoplay loop>
  <source src="<?php echo base_url(); ?>asset/uol/backsound/req_hani.mpeg" type="audio/mpeg">
</audio>
...
<div class="resonsive-tab">
      ...
      <div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="<?php echo base_url()?>hani_yudha"><h5>Hani & Yudha</h5></a></div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>hani_yudha" data-menu="index"><h5>Hani Yudha</h5></a> </div>
    <div class="ver-menu">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      ...
                      <h1 class="wow fadeInLeft">Hani</h1>
                      <a href="<?php echo base_url()?>hani_yudha">
                      <span class="glyphicon glyphicon-heart"></span>
                      </a>
                      <h1 class="wow fadeInRight">Yudha</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>Sabtu, 28 September 2019</span></p>
                    </div>
                <div class="clearfix"></div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha22.jpg" alt="the-couple image" class="img-circle">
                            
                          </div>
                            </div>
                        <div class="the-couple-data">
                              <h3>Muflihani Nur Khairunnisa</h3>
                              <p class="about-the-couple">Putri pertama dari Bapak Jamalludin & Ibu Agus Rini Sulistiowaty</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha21.jpg" alt="the-couple image" class="img-circle">
                       
                      </div>
                        </div>
                    <div class="the-couple-data">
                          <h3>Yudha Mardiansyah</h3>
                          <p class="about-the-couple">Putra ketiga dari Bapak Said & Ibu Yayat Nurhayati</p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                          ...
                          <h5>Akad Nikah</h5>
                          <h4>Sabtu, 28 September 2019</h4>
                          <p>08.00 WIB - Selesai</p>
                          <img class="pin-icon" src="<?php echo base_url()?>asset/uol/love_bird/images/pin.png" alt="locationimage">
                          <p>Gedung PPMKP Ciawi, Jl. Raya Pertanian, Bendungan Ciawi, Kec. Ciawi, Bogor</p>
                          <p><a href="https://goo.gl/maps/qoUrhhUKCXqJE1Pj7">Petunjuk Lokasi</a></p>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="page-top display_none">
                    ...
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-1.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-1.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-3.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-3.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-2.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-2.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-4.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-4.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-5.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-5.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-6.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/haniyudha-6.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                          <div  class="fb-comments" data-href="http://mantenbaru.com/hani_yudha/" data-numposts="5" data-mobile="mobile" ></div>
                        </div>
                  </div>
                    </div>
              </div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                    ...
                    <div class="container">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15851.441894802641!2d106.8619975!3d-6.6642074!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x442bc228b055cff8!2sPPMKP%20Ciawi!5e0!3m2!1sen!2sid!4v1567582362418!5m2!1sen!2sid" width="100%" height="600" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
...
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/hani_yudha.js"></script>
