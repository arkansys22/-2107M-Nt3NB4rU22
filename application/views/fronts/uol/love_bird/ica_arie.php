...
<head>
     <title>Resepsi Ica & Arie - Undangan Pernikahan Online Mantenbaru</title>

    <meta charset="UTF-8">
    <meta name="description" content="Resepsi Ica & Arie - Undangan Pernikahan Online Mantenbaru">
    <meta name="author" content="mantenbaru.com">
    <meta name="site_url" content="<?php echo base_url()?>ica_arie/">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href='https://fonts.googleapis.com/css?family=Great+Vibes' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Roboto:400,100,300,500,700,900' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/style_arie.css">
    ...
    <link rel="shortcut icon" href="https://www.mantenbaru.com/asset/frontend/aspanel/img/fav.png" type="image/x-icon">
        ...
        <meta property="og:title" content="Resepsi Ica & Arie - Undangan Pernikahan Online Manten Baru">
        <meta property="og:site_name" content="Resepsi Ica & Arie | Undangan Pernikahan Online Manten Baru">
        <meta property="og:description" content="Resepsi Ica & Arie - Undangan Pernikahan Online Manten Baru">
        <meta property="og:url" content="<?php echo base_url()?>ica_arie/">
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/love_bird/images/ica_yadi/arie_date.jpg">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/love_bird/images/ica_yadi/arie_date.jpg">
...
<div class="resonsive-tab">
      ...
      <div class="header">
    <div class="container">
          <div class="logo-responsive pull-left"> <a href="<?php echo base_url()?>ica_arie"><h5>Ica & Arie</h5></a></div>
...
<div id="dl-menu" class="section1 navbar navbar-default navbar-fixed-top">
    ...
    <div class="logo-s2">
      <a href="<?php echo base_url()?>ica_arie" data-menu="index"><h5>Ica & Arie</h5></a> </div>
    <div class="ver-menu">
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="couple-name wow fadeInUp">
                      <h1 class="wow fadeInLeft">Ica</h1>
                      <span class="glyphicon glyphicon-heart"></span>
                      <h1 class="wow fadeInRight">Arie</h1>
                    </div>
                <div class="tag-line wow fadeInUp">
                      <p><span>Jum'at, 11 Januari 2019</span></p>
                    </div>
                <div class="clearfix"></div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/ica_yadi/ica.jpg" alt="the-couple image" class="img-circle">
                            
                          </div>
                            </div>
                        <div class="the-couple-data">
                              <h3>Khoirunnisa, S.Pd</h3>
                              <p class="about-the-couple">Putri pertama dari Bapak Muhammad Luthfillah & Ibu Nuryanti</p>
                            </div>
                      </div>
                        </div>
                  </div>
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/ica_yadi/arie02.jpg" alt="the-couple image" class="img-circle">
                      </div>
                        </div>
                    <div class="the-couple-data">
                          <h3>Hariyadi, S.Kom</h3>
                          <p class="about-the-couple">Putra tunggal dari Bapak Namat & Ibu Fatimah</p>
                        </div>
                  </div>
                    </div>
              </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                          ...
                          <h5>Akad Nikah</h5>
                          <h4>Sabtu, 29 Desember 2018</h4>
                          <p>09.00 WIB</p>
                          <img class="pin-icon" src="<?php echo base_url()?>asset/uol/love_bird/images/pin.png" alt="locationimage">
                          <p>Jl. Jatijajar II RT 07/08 No 20 ( TK Al Jannah ), Kec. Tapos, Kota Depok</p>
                        </div>
                  </div>
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                         ...
                         <h5>Resepsi Nikah</h5>
                        <h4>Jumat, 11 Januari 2019</h4>
                        <p>13.00 WIB - Selesai</p>
                          <img class="pin-icon" src="<?php echo base_url()?>asset/uol/love_bird/images/pin.png" alt="locationimage">
                          <p>Jl. Masjid Baitul Makmur, Pedurenan Depok, Cisalak, Pasar Cimanggis Depok, Jawa Barat.</p>
                         <p><a href="https://goo.gl/maps/irbkBzEL91G2">Petunjuk Lokasi</a></p>
                        </div>
                  </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="rsvp-form white-box wow fadeInUp col-md-10 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12" data-class="fadeInUp">
                        <p>Merupakan suatu kebahagian bagi kami apabila Bapak/Ibu/Saudara/i berkenan hadir untuk memberikan doa restu kepada kami.</p>
                          <div  class="fb-comments" data-href="http://mantenbaru.com/ica_arie/" data-numposts="5" data-mobile="mobile" ></div>
                          <br /><a href="<?php echo base_url()?>" target="_blank"><img src="<?php echo base_url()?>asset/uol/love_bird/images/logobottom.png" /></a>
                        </div>
                  </div>
                    </div>
              </div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-title wow fadeInUp" data-class="fadeInUp">
                      ...
                      <p><a href="https://goo.gl/maps/irbkBzEL91G2">Petunjuk Lokasi Klik Ini</a></p>
                    </div>
                    <div class="container">
          
                     <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d991.2811160874083!2d106.87396236322942!3d-6.377930399470538!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec828cf3c215%3A0x96b1021551b4c13!2sJl.+Masjid+Baitul+Makmur+Blok+Masjid+No.16%2C+RT.2%2FRW.2%2C+Cisalak+Ps.%2C+Cimanggis%2C+Kota+Depok%2C+Jawa+Barat+16452!5e0!3m2!1sen!2sid!4v1542253082913" width="100%" height="600" frameborder="0" style="border:0" allowfullscreen></iframe> 
                        </div>
              </div>
                </div>
          </div>
...
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/function_ica_arie.js"></script>
