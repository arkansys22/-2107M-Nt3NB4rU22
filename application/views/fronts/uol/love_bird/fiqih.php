...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/style_fiqih.css">
    ...
    <link rel="shortcut icon" href="https://www.mantenbaru.com/asset/frontend/aspanel/img/fav.png" type="image/x-icon">
        ...
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/foto_manten/gallery-3.png">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/foto_manten/gallery-3.png">
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/foto_manten/fiqih-foto_dira.png" alt="the-couple image" class="img-circle">
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/foto_manten/fiqih-foto_fiqih.png" alt="the-couple image" class="img-circle">
                        <div class="the-couple-img-hover">
                              <div class="social text-center"><a class="fb-color" href="#" target="_blank"><i class="fa fa-facebook"></i></a><a class="tw-color" href="#" target="_blank"><i class="fa fa-twitter"></i></a><a class="gp-color" href="#" target="_blank"><i class="fa fa-google-plus"></i></a></div>
                            </div>
                      </div>
            ...
            <div class="main-section-s2">
                ...
                <div class="page-top display_none">
                    ...
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-1.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-1.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-2.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-2.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-3.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-3.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-4.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-4.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-5.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-5.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/foto_manten/gallery-6.png" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/foto_manten/gallery-6.png">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                        </div>
                  </div>
...
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/function_fiqih.js"></script>
