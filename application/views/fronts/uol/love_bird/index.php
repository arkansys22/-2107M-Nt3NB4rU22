...
<head>
    <link rel="shortcut icon" href="<?php echo base_url()?>asset/uol/style/images/favicon.png">
    <meta charset="UTF-8">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/style.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/bootstrap.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/timer.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/animations.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/component.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/slick.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/slick-theme.css">
    <link type="text/css" href="<?php echo base_url()?>asset/uol/love_bird/css/jquery.countdown.css" rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/gridlayout.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/jquery.fancybox.css" media="screen" />
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/materialadmin.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/font-awesome.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/animate.css">
    <link type="text/css" rel="stylesheet" href="<?php echo base_url()?>asset/uol/love_bird/css/hover.css">
    <script src="<?php echo base_url()?>asset/uol/love_bird/js/modernizr.custom.js"></script>
<link rel="shortcut icon" href="https://www.mantenbaru.com/asset/frontend/aspanel/img/fav.png" type="image/x-icon">
    <meta property="og:title" content="Miftah & Japar - Undangan Pernikahan Online Manten Baru">
        ...
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/love_bird/images/home-back.png">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/love_bird/images/home-back.png">
        <meta property="og:image:width" content="400"/>
        <meta property="og:image:height" content="300"/>
        <meta property="og:type" content="article">
        <?php $this->load->view('fronts/utama/ganalytics'); ?>
...
<div class="resonsive-tab">
    ...
    <div class="container">
          ...
          <div class="hamburger pull-right"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/1466014460_menu-alt.png" alt="Navicon"> </div>
    </div>
        ...
        <div class="page-fixed">
            ...
            <div class="main-section-s2">
                ...
                <div class="countdown countdown-container container">
                   ...
                   <a href="<?php echo base_url()?>" target="_blank"><img src="<?php echo base_url()?>asset/uol/love_bird/images/logobottom.png" /></a>
                    </div>
              </div>
                </div>
          </div>
        ...
        <div class="page-scroll">
            ...
            <div class="main-section-s2">
                ...
                <div class="container">
                    ...
                    <div class="col-md-12 couple-responsive-padding">
                        ...
                        <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                              <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/bride.jpg" alt="the-couple image" class="img-circle">
                ...
                <div class="col-md-12 couple-responsive-padding">
                    ...
                    <div class="the-couple-img col-md-12 col-md-offset-0 col-xs-12">
                          <div class="person-image"> <img src="<?php echo base_url()?>asset/uol/love_bird/images/groom.jpg" alt="the-couple image" class="img-circle">
                        <div class="the-couple-img-hover">
                              <div class="social text-center"><a class="fb-color" href="#" target="_blank"><i class="fa fa-facebook"></i></a><a class="tw-color" href="#" target="_blank"><i class="fa fa-twitter"></i></a><a class="gp-color" href="#" target="_blank"><i class="fa fa-google-plus"></i></a></div>
                            </div>
                      </div>
    ...
    <div class="pt-page pt-page-5">
        ...
        <div class="page-fixed">
			...
			C113.857,64.646,113.954,64.641,114.052,64.641z" />
                          ...
                          <img class="pin-icon" src="<?php echo base_url()?>asset/uol/love_bird/images/pin.png" alt="locationimage">
            ...
            <div class="main-section-s2">
                ...
                <div class="page-top display_none">
                    ...
                    <div class="gridlayout">
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah1.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah1.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah2.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah2.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah3.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah3.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah4.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah4.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah5.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah5.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                          <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah6.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah6.jpg">
                            <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                            </a> </div>
                            <div class="grid-item"> <a class="fancybox" href="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah7.jpg" data-fancybox-group="gallery"> <img class="img-responsive" alt="gallery-image" src="<?php echo base_url()?>asset/uol/love_bird/images/gallery/miftah7.jpg">
                              <div class="gallery-image-hover"><i class="glyphicon glyphicon-search"></i></div>
                              </a> </div>
                        </div>
                  </div>
...
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery-2.1.4.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/function.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/slick.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/easyResponsiveTabs.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/timer.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.final-countdown.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.dlmenu.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/pagetransitions.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.countdown.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.masonarygrid.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.fancybox.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/menu.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/wow.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="<?php echo base_url()?>asset/uol/love_bird/js/formValidation.js"></script>
        <div id="fb-root"></div>
