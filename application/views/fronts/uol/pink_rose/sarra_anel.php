...
<head>
        ...
        <meta property="og:image" content="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/share.jpg">
        <meta property="og:image:url" content="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/share.jpg">
	...
	<body id="home" class="theme-flowers">
	    ...
	    <audio autoplay loop id="myAudio">
            <source src="<?php echo base_url(); ?>asset/uol/backsound/marry_your_daughter.mp3" type="audio/mpeg">
        </audio>
<style>
    #over-layar {
        position:fixed;
			...
			<div class="container">
				...
				<div id="about" class="row groom-bride">
					...
					<div class="col-sm-6 big-photo text-center">
						...
						<img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/about-us.png" alt="about-us">
		...
		<section id="gallery" class="gallery">
			<div class="container">
				...
				<div class="owl-carousel gallery-carousel owl-theme responsive-0">
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/1putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/1putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/2putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/2putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/3putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/3putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/4putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/4putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/5putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/5putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/6putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/6putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/7putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/7putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/8putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/8putih.jpg" alt=""></a>
					</div>
					<div>
						<a href="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/9putih.jpg" data-lightbox="roadtrip"><img src="<?php echo base_url()?>asset/uol/pink_rose/sarra_anel/9putih.jpg" alt=""></a>
					</div>
				</div>
			</div>
		</section>
...
<section id="location" class="location text-center">
	<div class="container">
		...
		<footer class="pink-color">
			<div class="footer-lines">
				<div class="container">
					...
					<p><a href="<?php echo base_url()?>"><img src="<?php echo base_url()?>asset/uol/weddingbook/includes/images/borders/logo.png" /></a></p>
				</div>
		...
		<!-- Main -->
		<script src="<?php echo base_url()?>asset/uol/pink_rose/js/sarra_anel.js"></script>
		<!-- Google map -->
