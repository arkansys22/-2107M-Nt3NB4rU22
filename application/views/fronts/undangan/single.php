...
<html lang="id">
  <head>
    <?php $this->load->view('fronts/undangan/meta')?>
    ...
    <div class="detail-wrapper">
      <div class="container">
            <div class="row padd-90">
              <div class="col-xs-12 col-md-8">
                <div class="detail-header style-2">
                  ...
                  <p></p>Rp. <?php echo number_format($post_news->harga_min,0,',','.') ?> - Rp. <?php echo number_format($post_news->harga_max,0,',','.')?> | <?php echo $post_news->views?> <img src="<?php echo base_url()?>asset/frontend/aspanel/img/car_icon_3.png" alt=""></p>
                </div>
            ...
            <div class="share clearfix">
              ...
              <ul>
                <li class="color-fb"><a href="http://www.facebook.com/sharer.php?u=<?php echo base_url("undangan/$post_news->judul_seo ") ?>" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo base_url("undangan/$post_news->judul_seo")?>','newwindow','width=400,height=350');  return false;" title="Facebook" target="_blank" ><i class="fa fa-facebook" ></i>Facebook</a></li>
                <li class="color-ig"><a href="whatsapp://send?text=<?php echo $post_news->judul ?> - Mantenbaru | <?php echo base_url("undangan/$post_news->judul_seo") ?>"><i class="fa fa-whatsapp"></i>Whatsapp</a></li>
              </ul>
            </div>
              </div>
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide radius-4 active" data-val="<?php echo $no ?>">
                        ...
                        <div class="vertical-bottom">
                          <h4 class="color-white"><a href="<?php echo base_url ("undangan/$post_new->judul_seo")?>"><?php echo $post_new->nama_kategori ?></a></h4>
                          <span class="font-style-2 color-white"><a href="<?php echo base_url ("undangan/$post_new->judul_seo")?>"><?php echo $post_new->nama ?></a></span>
