    ...
    <div class="detail-wrapper">
    	<div class="container">
    		<div class="detail-header">
              ...
              <div class="detail-category rate-wrap clearfix" >Rp. <?php echo number_format($post_news->harga_min,0,',','.') ?> - Rp. <?php echo number_format($post_news->harga_max,0,',','.')?> | <?php echo $post_news->views?> <img src="<?php echo base_url()?>asset/frontend/aspanel/img/car_icon_3.png" alt=""></div>
    			    </div>
              <div class="col-xs-12 col-sm-4">
    			    	<div class="share clearfix">
                  <div class="share-title color-dark-2">Bagikan : </div>
                  <li class="color-fb"><a href="http://www.facebook.com/sharer.php?u=<?php echo base_url("vendor/$post_news->judul_seo ") ?>" onclick="window.open('http://www.facebook.com/sharer.php?u=<?php echo base_url("vendor/$post_news->judul_seo ")?>','newwindow','width=400,height=350');  return false;" title="Facebook" target="_blank" ><i class="fa fa-facebook" ></i>FB</a></li>
                  <li class="color-ig"><a href="whatsapp://send?text=<?php echo $post_news->judul ?> - Mantenbaru| <?php echo base_url("vendor/$post_news->judul_seo ") ?>"><i class="fa fa-whatsapp"></i>WA</a></li>
                </div>
    			    </div>
    	       	</div>
           	</div>
    						...
    						<div class="swiper-container thumbnails-preview" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="1">
    			                <div class="swiper-wrapper">
    		                    	<div class="swiper-slide active" data-val="0">
    		                    		 <img class="img-responsive img-full" <?php if(empty($post_news->gambar)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
                         			        else { echo " <img src='".base_url()."asset/foto_vendor/".$post_news->gambar."'width='350' height='330'> ";}
                         			        ?>
                              </div>
    		                    	<div class="swiper-slide" data-val="1">
                                <img class="img-responsive img-full" <?php if(empty($post_news->gambar2)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
                                     else { echo " <img src='".base_url()."asset/foto_vendor/".$post_news->gambar2."'width='350' height='330'> ";}
                                     ?>
                              </div>
    		                    	<div class="swiper-slide" data-val="2">
                                <img class="img-responsive img-full" <?php if(empty($post_news->gambar3)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
                                     else { echo " <img src='".base_url()."asset/foto_vendor/".$post_news->gambar3."'width='350' height='330'> ";}
                                     ?>
                              </div>
    		                    	<div class="swiper-slide" data-val="3">
                                <img class="img-responsive img-full" <?php if(empty($post_news->gambar4)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
                                     else { echo " <img src='".base_url()."asset/foto_vendor/".$post_news->gambar4."'width='350' height='330'> ";}
                                     ?>
                              </div>
    		                    	<div class="swiper-slide" data-val="4">
                                <img class="img-responsive img-full" <?php if(empty($post_news->gambar5)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
    				...
    				<div class="swiper-slide" data-val="1">
                      ...
                      <img class="img-responsive img-full" <?php if(empty($post_news->gambar5)) {echo "<img src='".base_url()."asset/frontend/noimage.png' width='350' height='230'>";}
    					...
    					<div class="detail-content-block">
                            ...
                            <?php if(empty($post_news->youtube)) {echo "";}
                         			        else { echo " <iframe width='100%' height='300' src='https://www.youtube.com/embed/".$post_news->youtube."' frameborder='0' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe> ";}
                         			        ?>    
           		...
           		<div class="col-xs-12 col-md-4">
           			<div class="right-sidebar">
    					...
    					<div class="help-contact bg-grey-2">
    						...
    						<a class="help-phone color-dark-2 link-dr-blue" href="https://www.shorturl.at/OSU09"><img src="<?php echo base_url()?>asset/frontend/aspanel/img/detail/phone24-dark.png" alt="">0812-1012-6196</a>
    						<a class="help-mail color-dark-2 link-dr-blue" href="mailto:marketing@mantenbaru.com"><img src="<?php echo base_url()?>asset/frontend/aspanel/img/detail/letter-dark.png" alt="">marketing@mantenbaru.com</a>
    					</div><br>
                  ...
                  <div class="swiper-container" data-autoplay="0" data-loop="1" data-speed="100" data-center="0" data-slides-per-view="1">
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide radius-4 active" data-val="0">
                        <img class="center-image" <?php if(empty($post_new->gambar)) {echo "<img src='".base_url()."asset/frontend/noimage.png'>";}
                                                else { echo " <img src='".base_url()."asset/foto_vendor/".$post_new->gambar."'> ";}
                                                ?>
                      <div class="vertical-bottom">
                          <h4 class="color-white"><a href="<?php echo base_url ("vendor/$post_new->judul_seo")?>"><?php echo $post_new->nama_kategori ?></a></h4>
                          <span class="font-style-2 color-white"><a href="<?php echo base_url ("vendor/$post_new->judul_seo")?>"><?php echo $post_new->nama ?></a></span>
                ...
                <div class="widget-slider arrows">
                  <div class="swiper-container" data-autoplay="0" data-loop="1" data-speed="100" data-center="0" data-slides-per-view="1">
                    <div class="swiper-wrapper">
                      ...
                      ?>
                      <div class="swiper-slide radius-4 active" data-val="0">
                        <img class="center-image" <?php if(empty($post_new->gambar)) {echo "<img src='".base_url()."asset/asset/frontend/noimage.png'>";}
                                                else { echo " <img src='".base_url()."asset/foto_investasi/".$post_new->gambar."'> ";}
                                                ?>
                      <div class="vertical-bottom">
                          <h4 class="color-white"><a href="<?php echo base_url ("investasi/$post_new->judul_seo")?>"><?php echo $post_new->nama_kategori ?></a></h4>
                          <span class="font-style-2 color-white"><a href="<?php echo base_url ("investasi/$post_new->judul_seo")?>"><?php echo $post_new->nama ?></a></span>
