            ...
            <div class="sidebar-block">
              ...
              <ul class="sidebar-category color-1">
                <li class="active">
                  ...
                  <ul>
                    <li><a href="<?php echo base_url()?>vendor/kategori/photography">Photography</a></li>
                  ...
                  <div class="hotel-item style-3 bg-white">
                    <div class="table-view">
                        ...
                        <div class="title hotel-middle clearfix cell-view">
                          <div class="date list-hidden"><strong><?php echo $post_new[nama_kategori]?> <?php echo $post_new[lokasi]?></strong></div>
                            <h4><b><?php echo $post_new[nama]?></b></h4>
                                 <div class="rate-wrap">
                                    <i>Harga Mulai dari <?php echo number_format($post_new[harga_min],0,',','.')?></i>
                                  </div>
                        </div>
